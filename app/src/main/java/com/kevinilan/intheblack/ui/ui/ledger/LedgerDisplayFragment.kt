 ...
 * [LedgerDisplayFragment.OnListFragmentInteractionListener] interface.
 */
class LedgerDisplayFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_ledger_list, container, false)
