...
/**
 * Helper class for showing and canceling add transaction
 * notifications.
 *
 *
 ...
 */
object AddTransactionNotification {
    /**
     * The unique identifier for this type of notification.
     */
    private val NOTIFICATION_TAG = "AddTransaction"
     ...
     * presentation of add transaction notifications. Make
     * sure to follow the
     * [
 * Notification design guidelines](https://developer.android.com/design/patterns/notifications.html) when doing so.
    ...
    fun notify(
        ...
        val title = res.getString(
            R.string.add_transaction_notification_title_template, exampleString
        )
        val text = res.getString(
            R.string.add_transaction_notification_placeholder_text_template, exampleString
        )
        ...
        val builder = NotificationCompat.Builder(context)
            ...
            .setSmallIcon(R.drawable.ic_stat_add_transaction)
